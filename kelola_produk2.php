...
// Ambil data produk
$produk = $conn->query("SELECT * FROM produk2 ORDER BY id DESC");
?>
...
<main class="container mt-4">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h3>Kelola Produk 2</h3>
    <a href="tambah_produk2.php" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Produk</a>
  </div>
        ...
        <?php if ($produk->num_rows > 0): ?>
          <?php $no = 1; while($row = $produk->fetch_assoc()): ?>
            <tr style=" text-align: center">
              ...
              <td>
                <a href="edit_produk2.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning">Edit</a>
                <a href="hapus_produk2.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus produk ini?')">Hapus</a>
              </td>
            </tr>
          <?php endwhile; ?>
        <?php else: ?>
